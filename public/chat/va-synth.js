...
class VASynth {
  ...
  static PRESETS = {
    ...
    'Ethereal Strings': {
      osc1Type: 'triangle', osc2Type: 'sine', osc2Detune: 8, osc2Octave: 0,
      oscMix: 0.45, subGain: 0.1, filterFreq: 1200, filterQ: 0.4, filterEnvAmount: 800,
      attack: 3, decay: 3, sustain: 0.75, release: 6, lfoRate: 0.12, lfoDepth: 0.08
    },
    'Soft Lead': {
    ...
    'Ambient Drone': {
      osc1Type: 'sine', osc2Type: 'sine', osc2Detune: 4, osc2Octave: 0,
      oscMix: 0.4, subGain: 0.15, filterFreq: 600, filterQ: 0.5, filterEnvAmount: 200,
      attack: 5, decay: 4, sustain: 0.85, release: 8, lfoRate: 0.05, lfoDepth: 0.15
    },
    'Soft Keys': {
      osc1Type: 'sine', osc2Type: 'sine', osc2Detune: 6, osc2Octave: 1,
      oscMix: 0.35, subGain: 0.1, filterFreq: 2200, filterQ: 0.7, filterEnvAmount: 1800,
      attack: 0.01, decay: 1.8, sustain: 0.25, release: 2.5, lfoRate: 0.3, lfoDepth: 0.04
    }
  };
